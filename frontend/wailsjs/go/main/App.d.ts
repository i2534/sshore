...
export function CancelUpdateDownload():Promise<boolean>;

export function CheckUpdate(arg1:boolean):Promise<update.UpdateInfo>;

export function ClearSkippedUpdate():Promise<void>;
...
export function DiscardUpdateDownload():Promise<void>;

export function GetAppInfo():Promise<main.AppInfo>;

export function GetSettings():Promise<config.AppSettings>;

export function GetUpdateInfo():Promise<update.UpdateInfo>;
